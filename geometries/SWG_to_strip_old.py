...
def SWG_to_strip(dimension = 2, init_params = None, base_script = True, lithography_model = None, **kwargs):
    ...
    waveguides = _create_waveguides(wg_width, length, eps_in, eps_out)
    if not width_as_param:
        SWG_gratings = _create_SWG_Fingers(period, center_width, wg_width, num_gratings, static_gratings, swg_width, init_params, final_height, SWG_min_bound, SWG_max_bound, eps_in, eps_out)
    else:
        SWG_gratings = _create_SWG_Fingers(period, center_width, wg_width, num_gratings, static_gratings, swg_width, init_params, final_height, SWG_min_bound, SWG_max_bound, eps_in, eps_out)
    waveguide_bridge = _create_waveguide_bridge(init_params, num_gratings, length, wg_width, bridge_length, bridge_min_bound, SWG_max_bound, eps_in, eps_out)
...
def _create_SWG_Fingers(period, center_width, wg_width, num_gratings, static_gratings, swg_width, init_params, final_height, SWG_min_bound, SWG_max_bound, eps_in, eps_out):
...
def _create_waveguide_bridge(init_params, num_gratings, length, wg_width, bridge_length, bridge_min_bound, SWG_max_bound, eps_in, eps_out):
